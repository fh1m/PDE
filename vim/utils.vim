...
au BufEnter * ++nested if winnr('$') == 1 && bufname() == 'NvimTree_' . tabpagenr() | quit | endif " Close If Tree is ast
...
func! CompileRun()
  ...
  elseif &filetype == 'python'
    exec "AsyncRun -strip python3 $(VIM_FILENAME)"
  elseif &filetype == 'go'
...
func! Run()
  ...
  elseif &filetype == 'python'
    exec "AsyncRun -strip -mode=term -pos=floaterm -position=bottomright -width=0.5 -height=0.4 python3 $(VIM_FILENAME)"
  elseif &filetype == 'go'
